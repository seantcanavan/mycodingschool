...
class MyTestCase(unittest.TestCase):
    def test_something(self):
        ...
        dynamic_list.add(4) #1
        dynamic_list.add(6) #2
        dynamic_list.add(2) #3
        dynamic_list.add(3) #4
        dynamic_list.add(1) #5
        dynamic_list.add(6) #6
        dynamic_list.add(5) #7
        dynamic_list.add(8) #8
        dynamic_list.add(5) #9
        dynamic_list.add(9) #10
        ...
        dynamic_list.add_at(4, 0)  #1
        dynamic_list.add_at(10, 1) #2
        dynamic_list.add_at(2, 2)  #3
        dynamic_list.add_at(3, 3)  #4
        dynamic_list.add_at(1, 4)  #5
        dynamic_list.add_at(6, 5)  #6
        dynamic_list.add_at(5, 6)  #7
        dynamic_list.add_at(8, 7)  #8
        dynamic_list.add_at(5, 8)  #9
        dynamic_list.add_at(9, 9)  #10
        self.assertEqual(dynamic_list.get_at(9), 9) # assert 10th item = 9
        ...
        dynamic_list.add_at(22, 30) # there is nothing defined at position 30 so insertion takes place at the end
